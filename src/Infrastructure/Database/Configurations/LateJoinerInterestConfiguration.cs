...
internal sealed class LateJoinerInterestConfiguration : IEntityTypeConfiguration<LateJoinerInterest>
{
    public void Configure(EntityTypeBuilder<LateJoinerInterest> builder)
    {
